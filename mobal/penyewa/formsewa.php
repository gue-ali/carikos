            ...
            <div style="text-align:left;" class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" required class="form-control" placeholder="Nama Lengkap" name="nama" value="<?= $dasewa['nama'] ?>">
                  <label>No HP</label>
                  <input type="number" required class="form-control" placeholder="No HP" name="nohp" value="<?= $dasewa['nohp'] ?>">
                  <label>Email</label>
                  <input type="email" required class="form-control" placeholder="Masukkan Email Anda" name="email" value="">
                  <label>Alamat</label>
                  <textarea required class="form-control" placeholder="Alamat Asal Anda" name="alamat"><?= $dasewa['alamat'] ?></textarea>
