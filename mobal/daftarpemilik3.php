...
$result2 = mysqli_query($koneksi, "SELECT * FROM tbpemilik WHERE kdkos='".$_SESSION['kdkos']."'");
    ...
    <div class="card-group">
         <div class="card">
            ...
            <div class="card-body">
                 ...
                 <div class="daftar">
                 <input type="text" placeholder="nama kos" name="namakos" id="nama kos" value="<?php echo $row1['namakos'];?>">
                 <input type="text" placeholder="alamat lengkap kos" name="alamatkos" id="alamat lengkap kos">
  ...
  <div class="container">
    <div class="card-body">
      ...
      <div class="form-check">
               ...
               <div class="form-check">
                <input class="form-check-input" type="checkbox" name="kampus" value="1" id="defaultCheck1">
                <label class="form-check-label" for="defaultCheck1">
                  Kampus/ sekolah
                </label>
               </div>
