...
$ceksewa = mysqli_query($koneksi, "SELECT a.*, c.namakos, b.nama as namapenyewa from chat a 
left join tbpenyewa b on a.id_penyewa=b.nopenyewa
left join tbkos c on a.kdkos=c.kdkos where c.kdpemilik='$_SESSION[kode]'");
