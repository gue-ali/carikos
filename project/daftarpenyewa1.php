...
<html lang="en">
  ...
  <body>
        <nav class="navbar navbar-light bg-transparant">
                <a class="navbar-brand" href="daftarpenyewa.php">
                 <p style="color: #91b029 ;">< Kembali</p> 
                </a>
              </nav>
        <section>
                <form action="cekpenyewa.php" method="POST" enctype="multipart/form-data">
                    <div class="login-form">
                        <h4>CARIKOS</h4>
                         ...
                         <div class="textbox">
                             <input type="text" placeholder="no ktp" name="noktp" id="nama lengkap" required>
                         </div>
                         <div class="textbox">
                             <input type="text" placeholder="username" name="username" id="username" required>
                         </div>
                         <div class="textbox">
                             <input type="text" onkeypress="return hanyaAngka(event)" placeholder="no. hp" name="nohp" id="no. hp" maxlength="13"  required>
                         </div>
                         <div class="textbox">
