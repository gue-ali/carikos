...
if (isset($_POST["reset-request-submit"])) {
  ...
  $id = mysqli_query($koneksi, "SELECT * FROM tbpemilik WHERE email='$userEmail'");
  ...
  $url = "localhost/project/pemilik/createnew.php?selector=" . $selector . "&validator=" . bin2hex($token);
