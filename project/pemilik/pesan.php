...
$datlawan = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * from tbpenyewa  where nopenyewa='$datch[id_penyewa]'"));
?>
<div class="container">
  <div class="card-group" style="margin-top: 100px; margin-bottom: 50px;">
    <div class="card" style="background-color: #fff; ">
      <div style="text-align:left;" class="card-body">
        <h5 class="card-title">Data Pesan - <?= $datlawan['nama'] ?></h5>
      </div>
...
<script>
  ...
  var namalawan = "<?php echo $datlawan['nama']; ?>";
        ...
        for (i = 0; i < data.length; i++) {
          ...
          if (tipe == '2') {
            html += '<li class="reverse"> <div class="chat-time" >' + data[i].create_at + '</div>' +
              '<div class="chat-content"><h5>Anda</h5><div class = "box"   style="background-color: #f0f0f0;padding:8px;"> ' + data[i].isinya + ' </div> </div><hr></li>';
          } else if (tipe == '1') {
            html += '<li> ' +
