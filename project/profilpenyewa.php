          ...
          <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="container">
              <div class="content-center">
                ...
                <a class="btn btn-primary smooth-scroll mr-2" href="editpenyewa.php" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Edit profile</a>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>Anda telah masuk sebagai penyewa.</p>
                  <p>Sebagai penyewa anda dapat melakukan sewa atau pemesanan kamar kos.</p>
                </div>
              </div>
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
