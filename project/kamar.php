         ...
         <div class="card">
            ...
            <h5 class="card-title">Fasilitas Kamar</h5>
              <div class="form-check">
               ...
               <div class="col-md-12 form-group">
                 <input type="text" placeholder="harga" name="harga" id="harga" onkeypress="return hanyaAngka(event)" required>
                 <input type="text" placeholder="luas kamar satuan meter" name="luas" id="luas kamar" required>
