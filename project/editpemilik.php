...
<html lang="en">
  ...
  <body>
        ...
        <section>
                <form action="cekpemilikup.php" method="POST" id="myfrom">
                    <div class="login-form">
                        <h4>CARIKOS</h4>
                         ...
                         <div class="textbox">
                             <input type="text" placeholder="email" name="email" id="email" value="<?php echo $row ['email']; ?>" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
                         </div>
                         <div class="password">
                    ...
                    <input type="file" name="fotoprofil" required>
                         ...
                         <div class="login-btn">
                             <input class="btn2" type="submit" name="Daftar" value="Edit" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
